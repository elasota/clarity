...
{
    public class CallRloVirtualMethodInstruction : HighInstruction
    {
        ...
        public override Opcodes Opcode { get { return Opcodes.CallRloVirtualMethod; } }

        public CallRloVirtualMethodInstruction(CodeLocationTag codeLocation, uint vtableSlotIndex, HighSsaRegister returnDest, HighSsaRegister instanceSrc, HighSsaRegister[] parameters)
            : base(codeLocation)
        {
