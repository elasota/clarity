...
{
    public class LoadDelegateTargetInstruction : HighInstruction
    {
        ...
        public LoadDelegateTargetInstruction()
        {
        }

        public LoadDelegateTargetInstruction(CodeLocationTag codeLocation, HighSsaRegister dest, HighSsaRegister src)
            : base(codeLocation)
        {
            m_dest = dest;
            m_src = src;
        ...
        public override Opcodes Opcode { get { return Opcodes.LoadDelegateTarget; } }
        ...
        {
            return new LoadDelegateTargetInstruction(this.CodeLocation, m_dest, m_src);
        }
