...
{
    public sealed class GetArrayLengthInstruction : HighInstruction
    {
        ...
        public override Opcodes Opcode { get { return Opcodes.GetArrayLength; } }
        ...
        {
            return new GetArrayLengthInstruction(CodeLocation, m_dest, m_src);
        }
