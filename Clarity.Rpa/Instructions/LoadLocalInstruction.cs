...
{
    public sealed class LoadLocalInstruction : HighInstruction, ILocalUsingInstruction
    {
        ...
        public override Opcodes Opcode { get { return Opcodes.LoadLocal; } }

        public LoadLocalInstruction(CodeLocationTag codeLocation, HighSsaRegister dest, HighLocal local)
            : base(codeLocation)
        {
            m_dest = dest;
            m_local = local;
