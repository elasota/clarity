...
{
    public sealed class CallInstanceMethodInstruction : HighInstruction, IMethodReferencingInstruction
    {
        ...
        public override Opcodes Opcode { get { return Opcodes.CallInstanceMethod; } }
        ...
        public CallInstanceMethodInstruction()
        {
        }
        ...
        public override HighInstruction Clone()
        {
            ...
            return new CallInstanceMethodInstruction(CodeLocation, m_returnDestReg, m_methodSpec, m_instanceReg, parameters);
        }
